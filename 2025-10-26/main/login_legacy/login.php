  ...
  <script>
    document.addEventListener('DOMContentLoaded', function () {
      ...
      signupTab.addEventListener('click', function () {
        window.location.href = '/main/login/signup.php';
      });
...
<body>
  ...
  <div class="login-container">
    ...
    <form action="login_proc.php" method="post" name="login-form" id="login-form" class="login-form">
      <label>아이디
        <div class="input-wrap">
          <input type="text" placeholder="" name="id" id="id" />
        </div>
      </label>

      <label>비밀번호
        <div class="input-wrap">
          <input type="password" placeholder="숫자 및 특수문자 포함 7자 이상" name="pw" id="pw" />
