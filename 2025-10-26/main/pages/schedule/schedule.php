...
<!-- DEBUG: About to output script tag -->
<script>
    console.log('=== SCHEDULE SCRIPT START ===');
    ...
    console.log('Schedule variables set - Year:', window.scheduleNavigation.currentYear, 'Month:', window.scheduleNavigation.currentMonth);
    ...
    function loadScheduleMonth(year, month) {
        ...
        fetch(url)
            ...
            .then(html => {
                console.log('New schedule data loaded');
            ...
            .catch(err => {
                console.error('Failed to load new schedule:', err);
    ...
    function attachScheduleEvents() {
        console.log('Attaching schedule events...');
        
        var prevBtn = document.getElementById('prevBtn');
        var nextBtn = document.getElementById('nextBtn');
        
        console.log('Schedule buttons found - prev:', !!prevBtn, 'next:', !!nextBtn);
    ...
    console.log('=== SCHEDULE SCRIPT END ===');
</script>
<!-- DEBUG: Script tag ended -->
</body>
</html>
